        ...
        else
        {
            if(actual instanceof toStringErrorCode)
            {
                ...
                switch ((toStringErrorCode) actual) {
                    case Points -> System.out.println("Possibly you have wrong points values?");
                    case PointsSpaces -> System.out.println("You have spaces between each Point!");
                    case PolygonString -> System.out.println("Your first statement (before \\n) is wrong!");
                    case Exception -> System.out.println("Tried to throw an exception!");
